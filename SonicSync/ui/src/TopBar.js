...
const IconAndText = (props) => {
  return (
    ...
    >
      <Grid item>
        <ListItemIcon
          sx={{ color: (theme) => theme.palette.text.primary, height: "24px" }}
        >
          {props.icon}
        </ListItemIcon>
      </Grid>
...
const TopBar = (props) => {
  ...
  return (
    <>
      ...
      >
        <Grid item sx={{ width: { xs: "150px", sm: "300px", md: "400px" } }}>
          <FileUpload setModels={props.setModels} />
        </Grid>
          ...
          <CSVAutocomplete
            ...
            renderOption={(liProps, option, style) => (
              ...
              >
                ...
                <Typography
                  variant="caption"
                  sx={{ whiteSpace: "nowrap", ml: "auto", textAlign: "right" }}
                >
